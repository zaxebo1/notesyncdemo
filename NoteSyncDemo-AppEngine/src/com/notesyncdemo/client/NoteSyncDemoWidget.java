...
import com.notesyncdemo.client.MyRequestFactory.MessageRequest;
import com.notesyncdemo.shared.MessageProxy;

public class NoteSyncDemoWidget extends Composite {
  ...
  interface NoteSyncDemoUiBinder extends UiBinder<Widget, NoteSyncDemoWidget> {
  }

  private static NoteSyncDemoUiBinder uiBinder = GWT.create(NoteSyncDemoUiBinder.class);
